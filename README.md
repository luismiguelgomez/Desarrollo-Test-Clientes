...
Para ejecutar correctamente este proyecto, se recomienda utilizar **IntelliJ IDEA Community 2024.3.3** o la versión **Profesional**. Esto garantizará compatibilidad con las herramientas y configuraciones necesarias para el desarrollo.

Para ejecutar la aplicación, dirígete a la siguiente ruta en tu proyecto:
